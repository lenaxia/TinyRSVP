...
//
//	mockgen -source=internal/db/repositories/user_repository.go -destination=internal/testutil/mocks/repositories/mock_user_repository.go -package=repositories
//
