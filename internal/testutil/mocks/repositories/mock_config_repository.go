...
//
//	mockgen -source=internal/db/repositories/config_repository.go -destination=internal/testutil/mocks/repositories/mock_config_repository.go -package=repositories
//
