...
//
//	mockgen -source=internal/email/service.go -destination=internal/testutil/mocks/services/mock_email_service.go -package=services -mock_names=Service=MockEmailService
//
