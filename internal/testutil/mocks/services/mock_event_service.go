...
//
//	mockgen -source=internal/events/service.go -destination=internal/testutil/mocks/services/mock_event_service.go -package=services -mock_names=Service=MockEventService
//
