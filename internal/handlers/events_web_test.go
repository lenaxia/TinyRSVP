...
func TestNewEventWebHandlers(t *testing.T) {
	...
	if handlers.listTemplates == nil {
		t.Error("listTemplates is nil")
	}

	if handlers.formTemplates == nil {
		t.Error("formTemplates is nil")
	}

	if handlers.detailTemplates == nil {
		t.Error("detailTemplates is nil")
	}
}
